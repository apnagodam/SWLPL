...
class LabourBookListingActivity : BaseActivity<ActivityListingBinding?>() {
    ...
    fun setView(){
        ...
        binding!!.filterIcon.setOnClickListener {
            val builder = AlertDialog.Builder(this@LabourBookListingActivity)
            val inflater = (this@LabourBookListingActivity as Activity).layoutInflater
    ...
    private fun setAdapter() {
        ...
        val horizontalLayoutManager =
            LinearLayoutManager(this@LabourBookListingActivity, LinearLayoutManager.VERTICAL, false)
        binding!!.rvDefaultersStatus.layoutManager = horizontalLayoutManager
        laabourBookAdapter = LaabourBookAdapter(AllCases, this@LabourBookListingActivity, activity)
    ...
    fun ViewData(position: Int) {
        ...
        val builder = AlertDialog.Builder(this@LabourBookListingActivity, R.style.CustomAlertDialog)
        val inflater = (this@LabourBookListingActivity as Activity).layoutInflater
