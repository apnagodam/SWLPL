...
public class FirstkanthaParchiListingActivity extends BaseActivity<ActivityListingBinding> {
    ...
    public void ViewData(int position) {
        ...
        /////
        firstkantaParchiFile = Constants.IMAGE_BASE_URL_kanta_photo + AllCases.get(position).getFile();
        TruckImage = Constants.IMAGE_BASE_URL_kanta_photo + AllCases.get(position).getFile2();
