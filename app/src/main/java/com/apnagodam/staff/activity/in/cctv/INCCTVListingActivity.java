package com.apnagodam.staff.activity.in.cctv;
...
import com.apnagodam.staff.adapter.INCCTVAdapter;
...
public class INCCTVListingActivity extends BaseActivity<ActivityListingBinding> {
    private INCCTVAdapter incctvAdapter;
    ...
    protected void setUp() {
        ...
        binding.filterIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(INCCTVListingActivity.this);
                LayoutInflater inflater = ((Activity) INCCTVListingActivity.this).getLayoutInflater();
    ...
    private void setAdapter() {
        binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(INCCTVListingActivity.this, LinearLayoutManager.VERTICAL));
        binding.rvDefaultersStatus.setHasFixedSize(true);
        binding.rvDefaultersStatus.setNestedScrollingEnabled(false);
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(INCCTVListingActivity.this, LinearLayoutManager.VERTICAL, false);
        binding.rvDefaultersStatus.setLayoutManager(horizontalLayoutManager);
        incctvAdapter = new INCCTVAdapter(AllCases, INCCTVListingActivity.this, getActivity());
        binding.rvDefaultersStatus.setAdapter(incctvAdapter);
    }

    private void getAllCases(String search) {
        showDialog();
        apiService.getCCTVList("10", "" + pageOffset, "IN",search).enqueue(new NetworkCallback<CCTVListPojo>(getActivity()) {
            @Override
            protected void onSuccess(CCTVListPojo body) {
                ...
                if (body.getData() == null) {
                    ...
                    incctvAdapter.notifyDataSetChanged();
                }
            }
        });
    }
    ...
    public void ViewData(int position) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(INCCTVListingActivity.this, R.style.CustomAlertDialog);
        LayoutInflater inflater = INCCTVListingActivity.this.getLayoutInflater();
        ...
        kanta_parchi_file.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new PhotoFullPopupWindow(INCCTVListingActivity.this, R.layout.popup_photo_full, view, firstkantaParchiFile, null);
            }
        });
        truck_file.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TruckImage!=null)
                new PhotoFullPopupWindow(INCCTVListingActivity.this, R.layout.popup_photo_full, view, TruckImage, null);
            }
        });
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void checkVeehicleNo(int postion) {
        ...
        startActivity(INUploadCCTVFileClass.class, bundle);
    }
