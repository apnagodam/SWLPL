...
import com.apnagodam.staff.activity.out.gatepass.OutUploadGatePassClass;
...
public class UploadOutFirstQualtityReportsClass extends BaseActivity<ActivityUpdateQualityReportBinding> {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivityAndClear(OutFirstQualityReportListingActivity.class);
    }
    ...
    private void clickListner() {
        ...
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utility.showDecisionDialog(UploadOutFirstQualtityReportsClass.this, getString(R.string.alert), "Are You Sure to Summit?", new Utility.AlertCallback() {
                    @Override
                 ...
                 /*   if (fileReport == null) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.upload_commodity_file, Toast.LENGTH_LONG).show();
                            ...
                            if (packagingTypeID == null) {
                                ...
                                Utility.showAlertDialog(UploadOutFirstQualtityReportsClass.this, getString(R.string.alert), getResources().getString(R.string.packaging), new Utility.AlertCallback() {
                                    @Override
                                    public void callback() {
        ...
        binding.ReportsImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(UploadOutFirstQualtityReportsClass.this, R.layout.popup_photo_full, view, reportFile, null);
            }
        });
        binding.CommudityImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(UploadOutFirstQualtityReportsClass.this, R.layout.popup_photo_full, view, commudityFile, null);
            }
        });
    ...
    private void callImageSelector(int requestCamera) {
        ...
        Pix.start(UploadOutFirstQualtityReportsClass.this, options);
    }
    ...
    public void onNext() {
        ...
        apiService.uploadFirstQualityReports(new UploadFirstQualityPostData(CaseID, ReportImage, stringFromView(binding.etMoistureLevel), stringFromView(binding.etTcw), stringFromView(binding.etFmLevel), stringFromView(binding.etThin)
            ...
            protected void onSuccess(LoginResponse body) {
                Utility.showAlertDialog(UploadOutFirstQualtityReportsClass.this, getString(R.string.alert), body.getMessage(), new Utility.AlertCallback() {
                    @Override
                    public void callback() {
                        startActivityAndClear(OutFirstQualityReportListingActivity.class);
                    }
                ...
                if (data.hasExtra(Pix.IMAGE_RESULTS)) {
                    ...
                    if (requestCode == REQUEST_CAMERA) {
                        if (ReportsFileSelect) {
                            ReportsFileSelect = false;
                            CommudityFileSelect = false;
                            fileReport = new File(compressImage(returnValue.get(0)));
                            ...
                            ReportsFileSelect = false;
                            CommudityFileSelect = false;
                            fileCommudity = new File(compressImage(returnValue.get(0)));
