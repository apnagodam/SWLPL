...
public class INUploadCCTVFileClass extends BaseActivity<CctvUploadBinding> {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivityAndClear(INCCTVListingActivity.class);
    }
    ...
    private void clickListner() {
        ...
        binding.btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utility.showDecisionDialog(INUploadCCTVFileClass.this, getString(R.string.alert), "Are You Sure to Summit?", new Utility.AlertCallback() {
                    @Override
        ...
        binding.KanthaImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (firstcctvfileValue==null){
                    ...
                    new PhotoFullPopupWindow(INUploadCCTVFileClass.this, R.layout.popup_photo_full, view, firstcctvfileValue, null);
                }
        ...
        binding.TruckImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (secoundcctvfileValue==null){
                    ...
                    new PhotoFullPopupWindow(INUploadCCTVFileClass.this, R.layout.popup_photo_full, view, secoundcctvfileValue, null);
                }
            }
        });
    ...
    private void callImageSelector(int requestCamera) {
        ...
        Pix.start(INUploadCCTVFileClass.this, options);
    }
    ...
    public void onNext() {
        ...
        apiService.uploadCCTVFile(new UploadCCTVPostData(CaseID, stringFromView(binding.notes), KanthaImage, secoundFileCCTVImage)).enqueue(new NetworkCallback<LoginResponse>(getActivity()) {
            ...
            protected void onSuccess(LoginResponse body) {
                Utility.showAlertDialog(INUploadCCTVFileClass.this, getString(R.string.alert), body.getMessage(), new Utility.AlertCallback() {
                    @Override
                    public void callback() {
                        startActivityAndClear(INCCTVListingActivity.class);
                    }
