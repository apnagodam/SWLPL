...
import com.apnagodam.staff.activity.out.releaseorder.OUTReleaseOrderClass;
...
public class OUTDeliverdOrderListingActivity extends BaseActivity<ActivityListingBinding> {
    private OUTDeliverdOrderAdapter truckBookAdapter;
    ...
    protected void setUp() {
        ...
        binding.titleHeader.setText(getResources().getString(R.string.out_deiverd_book));
        ...
        binding.filterIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OUTDeliverdOrderListingActivity.this);
                LayoutInflater inflater = ((Activity) OUTDeliverdOrderListingActivity.this).getLayoutInflater();
    ...
    private void setAdapter() {
        binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(OUTDeliverdOrderListingActivity.this, LinearLayoutManager.HORIZONTAL));
        binding.rvDefaultersStatus.setHasFixedSize(true);
        binding.rvDefaultersStatus.setNestedScrollingEnabled(false);
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(OUTDeliverdOrderListingActivity.this, LinearLayoutManager.VERTICAL, false);
        binding.rvDefaultersStatus.setLayoutManager(horizontalLayoutManager);
        truckBookAdapter = new OUTDeliverdOrderAdapter(AllCases, OUTDeliverdOrderListingActivity.this,getActivity());
...
//        pagination(horizontalLayoutManager);
    ...
    private void getAllCases(String search) {
        showDialog();
        apiService.getDeliveredOrderList("10", pageOffset, "OUT",search).enqueue(new NetworkCallbackWProgress<ReleaseOrderPojo>(getActivity()) {
            @Override
    ...
    public void ViewData(int position) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(OUTDeliverdOrderListingActivity.this, R.style.CustomAlertDialog);
        LayoutInflater inflater = OUTDeliverdOrderListingActivity.this.getLayoutInflater();
        ...
        TruckImage = Constants.delivery_order_photo + AllCases.get(position).getFile();
        reports_file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OUTDeliverdOrderListingActivity.this, R.layout.popup_photo_full, view, TruckImage, null);
            }
        });
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void checkVeehicleNo(int postion) {
        ...
        startActivity(OUTDeliverdUpoladOrderClass.class, bundle);
    }
