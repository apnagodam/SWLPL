...
public class OutUploadFirrstkantaParchiClass extends BaseActivity<KanthaParchiUploadBinding> {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivityAndClear(OutFirstkanthaParchiListingActivity.class);
    }
    ...
    private void clickListner() {
        ...
        binding.btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utility.showDecisionDialog(OutUploadFirrstkantaParchiClass.this, getString(R.string.alert), "Are You Sure to Summit?", new Utility.AlertCallback() {
                    @Override
        ...
        binding.KanthaImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutUploadFirrstkantaParchiClass.this, R.layout.popup_photo_full, view, firstkantaParchiFile, null);
            }
        });
        binding.TruckImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutUploadFirrstkantaParchiClass.this, R.layout.popup_photo_full, view, TruckImage, null);
            }
        });
    ...
    public void onNext() {
        ...
        apiService.uploadFirstkantaParchi(new UploadFirstkantaParchiPostData(CaseID, stringFromView(binding.notes), KanthaImage, truckImageImage)).enqueue(new NetworkCallback<LoginResponse>(getActivity()) {
            ...
            protected void onSuccess(LoginResponse body) {
                Utility.showAlertDialog(OutUploadFirrstkantaParchiClass.this, getString(R.string.alert), body.getMessage(), new Utility.AlertCallback() {
                    @Override
                    public void callback() {
                        startActivityAndClear(OutFirstkanthaParchiListingActivity.class);
                    }
