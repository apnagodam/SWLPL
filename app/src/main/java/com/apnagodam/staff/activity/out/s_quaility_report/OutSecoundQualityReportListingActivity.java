...
public class OutSecoundQualityReportListingActivity extends BaseActivity<ActivityListingBinding> {
    private String ReportsFile, CommudityImage;
    private OutSecoundQualityReportAdapter outSecoundQualityReportAdapter;
    ...
    protected void setUp() {
       ...
       /* binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(SecoundQualityReportListingActivity.this, LinearLayoutManager.VERTICAL));
        ...
        binding.filterIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OutSecoundQualityReportListingActivity.this);
                LayoutInflater inflater = ((Activity) OutSecoundQualityReportListingActivity.this).getLayoutInflater();
    ...
    private void setAdapter() {
        binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(OutSecoundQualityReportListingActivity.this, LinearLayoutManager.VERTICAL));
        binding.rvDefaultersStatus.setHasFixedSize(true);
        binding.rvDefaultersStatus.setNestedScrollingEnabled(false);
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(OutSecoundQualityReportListingActivity.this, LinearLayoutManager.VERTICAL, false);
        binding.rvDefaultersStatus.setLayoutManager(horizontalLayoutManager);
        outSecoundQualityReportAdapter = new OutSecoundQualityReportAdapter(AllCases, OutSecoundQualityReportListingActivity.this, getActivity());
        binding.rvDefaultersStatus.setAdapter(outSecoundQualityReportAdapter);

    }

    private void getAllCases(String search) {
        showDialog();
        apiService.getS_qualityReportsList("10", "" + pageOffset, "OUT",search).enqueue(new NetworkCallback<SecoundQuilityReportListResponse>(getActivity()) {
            @Override
    ...
    public void ViewData(int position) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(OutSecoundQualityReportListingActivity.this, R.style.CustomAlertDialog);
        LayoutInflater inflater = OutSecoundQualityReportListingActivity.this.getLayoutInflater();
        ...
        reports_file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutSecoundQualityReportListingActivity.this, R.layout.popup_photo_full, view, ReportsFile, null);
            }
        });
        commodity_file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutSecoundQualityReportListingActivity.this, R.layout.popup_photo_full, view, CommudityImage, null);
            }
        });
