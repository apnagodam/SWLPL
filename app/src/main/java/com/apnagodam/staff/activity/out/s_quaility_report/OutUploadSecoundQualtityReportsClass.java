...
public class OutUploadSecoundQualtityReportsClass extends BaseActivity<ActivityUpdateQualityReportBinding> {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivityAndClear(OutSecoundQualityReportListingActivity.class);
    }
    ...
    private void clickListner() {
        ...
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utility.showDecisionDialog(OutUploadSecoundQualtityReportsClass.this, getString(R.string.alert), "Are You Sure to Summit?", new Utility.AlertCallback() {
                    @Override
        ...
        binding.ReportsImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutUploadSecoundQualtityReportsClass.this, R.layout.popup_photo_full, view, reportFile, null);
            }
        });
        binding.CommudityImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutUploadSecoundQualtityReportsClass.this, R.layout.popup_photo_full, view, commudityFile, null);
            }
        });
    ...
    private void callImageSelector(int requestCamera) {
        ...
        Pix.start(OutUploadSecoundQualtityReportsClass.this, options);
    }
