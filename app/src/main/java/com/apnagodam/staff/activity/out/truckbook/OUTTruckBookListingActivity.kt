...
class OUTTruckBookListingActivity() : BaseActivity<ActivityListingBinding?>() {
    ...
    override fun setUp() {
        ...
        binding!!.filterIcon.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                val builder = AlertDialog.Builder(this@OUTTruckBookListingActivity)
                val inflater = (this@OUTTruckBookListingActivity as Activity).layoutInflater
...
*/
    ...
    */
    ...
    fun ViewData(position: Int) {
        ...
        val builder =
            AlertDialog.Builder(this@OUTTruckBookListingActivity, R.style.CustomAlertDialog)
        val inflater = this@OUTTruckBookListingActivity.layoutInflater
