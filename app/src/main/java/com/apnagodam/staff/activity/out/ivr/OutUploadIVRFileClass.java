...
import com.apnagodam.staff.activity.in.ivr.INUploadIVRFileClass;
...
public class OutUploadIVRFileClass extends BaseActivity<IvrUploadBinding> implements CallBackPermission {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivityAndClear(OutIVRListingActivity.class);
    }
    boolean isValid() {
    ...
    private void clickListner() {
        ...
        binding.btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Utility.showDecisionDialog(OutUploadIVRFileClass.this, getString(R.string.alert), "Are You Sure to Summit?", new Utility.AlertCallback() {
                    @Override
        ...
        binding.uploadKantha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                runPermissions.permissionMulti(OutUploadIVRFileClass.this, Permission.GELLERY);
            }
        });
    ...
    public void onNext() {
        apiService.uploadIVRFile(new UploadIVRPostData(CaseID, stringFromView(binding.notes), audiofile,stringFromView(binding.etCustomerWeight),stringFromView(binding.etCustomerBags))).enqueue(new NetworkCallback<LoginResponse>(getActivity()) {
            ...
            protected void onSuccess(LoginResponse body) {
                Utility.showAlertDialog(OutUploadIVRFileClass.this, getString(R.string.alert), body.getMessage(), new Utility.AlertCallback() {
                    @Override
                    public void callback() {
                        startActivityAndClear(OutIVRListingActivity.class);
                    }
