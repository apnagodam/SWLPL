...
public class OutFirstkanthaParchiListingActivity extends BaseActivity<ActivityListingBinding> {
    private OutFirstkanthaparchiAdapter outFirstkanthaparchiAdapter;
    ...
    protected void setUp() {
      ...
      /*  binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(FirstkanthaParchiListingActivity.this, LinearLayoutManager.VERTICAL));
        ...
        binding.filterIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OutFirstkanthaParchiListingActivity.this);
                LayoutInflater inflater = ((Activity) OutFirstkanthaParchiListingActivity.this).getLayoutInflater();
    ...
    private void setAdapter() {
        binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(OutFirstkanthaParchiListingActivity.this, LinearLayoutManager.VERTICAL));
        binding.rvDefaultersStatus.setHasFixedSize(true);
        binding.rvDefaultersStatus.setNestedScrollingEnabled(false);
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(OutFirstkanthaParchiListingActivity.this, LinearLayoutManager.VERTICAL, false);
        binding.rvDefaultersStatus.setLayoutManager(horizontalLayoutManager);
        outFirstkanthaparchiAdapter = new OutFirstkanthaparchiAdapter(AllCases, OutFirstkanthaParchiListingActivity.this, getActivity());
        binding.rvDefaultersStatus.setAdapter(outFirstkanthaparchiAdapter);
    }

    private void getAllCases(String search) {
        showDialog();
        apiService.getf_kanthaParchiList("10", "" + pageOffset, "OUT",search).enqueue(new NetworkCallback<FirstkanthaParchiListResponse>(getActivity()) {
            @Override
    ...
    public void ViewData(int position) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(OutFirstkanthaParchiListingActivity.this, R.style.CustomAlertDialog);
        LayoutInflater inflater = OutFirstkanthaParchiListingActivity.this.getLayoutInflater();
        ...
        kanta_parchi_file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutFirstkanthaParchiListingActivity.this, R.layout.popup_photo_full, view, firstkantaParchiFile, null);
            }
        });
        truck_file.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new PhotoFullPopupWindow(OutFirstkanthaParchiListingActivity.this, R.layout.popup_photo_full, view, TruckImage, null);
            }
        });
        cancel_btn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void checkVeehicleNo(int postion) {
        ...
        startActivity(OutUploadFirrstkantaParchiClass.class, bundle);
    }
