...
public class PVListingActivityClass extends BaseActivity<ActivityListingPvBinding> {
    private PVListAdpter pvListAdpter;
    ...
    protected void setUp() {
        ...
        binding.filterIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PVListingActivityClass.this);
                LayoutInflater inflater = ((Activity) PVListingActivityClass.this).getLayoutInflater();
    ...
    private void setAdapter() {
        binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(PVListingActivityClass.this, LinearLayoutManager.VERTICAL));
        binding.rvDefaultersStatus.setHasFixedSize(true);
        binding.rvDefaultersStatus.setNestedScrollingEnabled(false);
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(PVListingActivityClass.this, LinearLayoutManager.VERTICAL, false);
        binding.rvDefaultersStatus.setLayoutManager(horizontalLayoutManager);
        pvListAdpter = new PVListAdpter(AllCases, PVListingActivityClass.this, getActivity());
    ...
    public void ViewData(int position) {
        BottomSheetDialog dialog = new BottomSheetDialog(PVListingActivityClass.this);
        ...
        apiService.getstockdetails("" + AllCases.get(position).getId()).enqueue(new NetworkCallbackWProgress<StockDetailsPVPojo>(getActivity()) {
            ...
            protected void onSuccess(StockDetailsPVPojo body) {
                ...
                rv_defaulters_status.addItemDecoration(new DividerItemDecoration(PVListingActivityClass.this, LinearLayoutManager.VERTICAL));
                ...
                PVListingActivityClass.PVStockDetailsAdpter adpter = new PVListingActivityClass.PVStockDetailsAdpter(body.getData(), PVListingActivityClass.this);
    ...
    public class PVStockDetailsAdpter extends RecyclerView.Adapter<PVStockDetailsAdpter.CommudityResponseViewHolder> {
        ...
        public PVStockDetailsAdpter(List<StockDetailsPVPojo.Datum> body, PVListingActivityClass pvListingActivityClass) {
