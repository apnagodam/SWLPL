...
public class OUTLabourBookListingActivity extends BaseActivity<ActivityListingBinding> {
    private OUTLaabourBookAdapter laabourBookAdapter;
    ...
    protected void setUp() {
      ...
      /*  binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(LabourBookListingActivity.this, LinearLayoutManager.VERTICAL));
        ...
        binding.filterIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OUTLabourBookListingActivity.this);
                LayoutInflater inflater = ((Activity) OUTLabourBookListingActivity.this).getLayoutInflater();
    ...
    private void setAdapter() {
        binding.rvDefaultersStatus.addItemDecoration(new DividerItemDecoration(OUTLabourBookListingActivity.this, LinearLayoutManager.VERTICAL));
        binding.rvDefaultersStatus.setHasFixedSize(true);
        binding.rvDefaultersStatus.setNestedScrollingEnabled(false);
        LinearLayoutManager horizontalLayoutManager = new LinearLayoutManager(OUTLabourBookListingActivity.this, LinearLayoutManager.VERTICAL, false);
        binding.rvDefaultersStatus.setLayoutManager(horizontalLayoutManager);
        laabourBookAdapter = new OUTLaabourBookAdapter(AllCases, OUTLabourBookListingActivity.this,getActivity());
    ...
    private void getAllCases(String search) {
        showDialog();
        apiService.getLabourBookList("10", ""+pageOffset,"OUT",search).enqueue(new NetworkCallback<AllLabourBookListResponse>(getActivity()) {
            @Override
    ...
    public void ViewData(int position) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(OUTLabourBookListingActivity.this, R.style.CustomAlertDialog);
        LayoutInflater inflater = ((Activity) OUTLabourBookListingActivity.this).getLayoutInflater();
    ...
    public void checkVeehicleNo(int postion) {
        ...
        startActivity(OUTLabourBookUploadClass.class, bundle);
    }
