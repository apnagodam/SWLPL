...
public class AllTruckBookListResponse extends BaseResponse {
    @SerializedName("data")
    @Expose
    private TruckBookCollection truckBookCollection;

    public TruckBookCollection getTruckBookCollection() {
        return truckBookCollection;
    }

    public void setTruckBookCollection(TruckBookCollection truckBookCollection) {
