...
public class AllLabourBookListResponse extends BaseResponse {
    ...
    public class Datum {
        ...
        @SerializedName("l_b_location")
        @Expose
        private String l_b_location;
        ...
        public String getL_b_location() {
            return l_b_location;
        }

        public void setL_b_location(String l_b_location) {
            this.l_b_location = l_b_location;
        }
