...
public class CCTVListPojo extends BaseResponse {
    @SerializedName("data")
    @Expose
    private Data data;
    ...
    public class Datum {
        public String getS_q_case_id_in() {
            return s_q_case_id_in;
        }

        public void setS_q_case_id_in(String s_q_case_id_in) {
            this.s_q_case_id_in = s_q_case_id_in;
        }

        public String getS_k_p_case_id_out() {
            return s_k_p_case_id_out;
        }

        public void setS_k_p_case_id_out(String s_k_p_case_id_out) {
            this.s_k_p_case_id_out = s_k_p_case_id_out;
        }

        @SerializedName("s_q_case_id_in")
        @Expose
        private String s_q_case_id_in;
        @SerializedName("s_k_p_case_id_out")
        @Expose
        private String s_k_p_case_id_out;
        @SerializedName("id")
        @Expose
        private Integer id;
