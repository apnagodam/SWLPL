...
public class UploadSecoundQualityPostData {
    ...
    @SerializedName("send_to_report_file")
    @Expose
    private String labReportFile;

    public UploadSecoundQualityPostData(String case_id, String report_file, ArrayList<UploadFirstQualityPostData.CommodityData> commodityList, String packaging_type, String infested, String live_insects, String notes, String commodity_img, String extraClaim, String sendToLab, String labReportFile) {
