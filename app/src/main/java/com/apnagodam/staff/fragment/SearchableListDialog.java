...
import com.apnagodam.staff.adapter.SearchableAdapter;
...
public class SearchableListDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Change End
        View rootView = inflater.inflate(R.layout.searchable_spinner_dialog, null);
         items = (List) getArguments().getSerializable(ITEMS);
        setData(rootView,items);
    ...
    private void setData(View rootView, List items) {
        _listViewItems = (ListView) rootView.findViewById(R.id.listItems);
        searchableAdapter = new SearchableAdapter(getActivity(), items);
        _listViewItems.setAdapter(searchableAdapter);
        ...
        _searchView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                searchableAdapter.getFilter().filter(cs.toString());
                //((ArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(cs);
                if (null != _onSearchTextChanged) {
                    _onSearchTextChanged.onSearchTextChanged(cs);
                }
            }
        ...
        _listViewItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                _searchableItem.onSearchableItemClicked(searchableAdapter.getItem(position), position);
                getDialog().dismiss();
            }
        });
    }
    ...
    public interface OnSearchTextChanged {
        void onSearchTextChanged(CharSequence strText);
    }
}
