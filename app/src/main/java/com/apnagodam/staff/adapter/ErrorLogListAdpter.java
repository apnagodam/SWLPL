...
public class ErrorLogListAdpter extends RecyclerView.Adapter<ErrorLogListAdpter.CommudityResponseViewHolder> {
    private List<ErrorLogListPojo.Datum> commudityResponseList;
    private Context context;
    private BaseActivity activity;

    public ErrorLogListAdpter(List<ErrorLogListPojo.Datum> body, MyErrorLogListClass myErrorLogListClass, BaseActivity activity) {
        this.commudityResponseList = body;
        this.context = myErrorLogListClass;
    ...
    public void onBindViewHolder(CommudityResponseViewHolder holder, final int position) {
        ...
        holder.tv_action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (context instanceof MyErrorLogListClass) {
                    ((MyErrorLogListClass) context).cancelConv(position);
                }
            }
        });
        holder.view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (context instanceof MyErrorLogListClass) {
                    ((MyErrorLogListClass) context).ViewData(position);
                }
            }
        });
    }
