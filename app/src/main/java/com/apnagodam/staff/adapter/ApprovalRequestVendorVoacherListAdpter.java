...
public class ApprovalRequestVendorVoacherListAdpter extends RecyclerView.Adapter<ApprovalRequestVendorVoacherListAdpter.CommudityResponseViewHolder> {
    private List<AllVendorConvancyList.Datum> commudityResponseList;
    private Context context;
    private BaseActivity activity;

    public ApprovalRequestVendorVoacherListAdpter(List<AllVendorConvancyList.Datum> getOrdersList, ApprovalRequestVendorVoacherListClass approvalRequestVendorVoacherListClass, BaseActivity activity) {
        this.commudityResponseList = getOrdersList;
        this.context = approvalRequestVendorVoacherListClass;
       ...
       /* if (commudityResponseList.get(position).getStatus() != null) {
        ...
        holder.tv_action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (context instanceof ApprovalRequestVendorVoacherListClass) {
                    ((ApprovalRequestVendorVoacherListClass) context).cancelConv(position);
                }
            }
        });
        holder.tv_action_apprved.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (context instanceof ApprovalRequestVendorVoacherListClass) {
                    ((ApprovalRequestVendorVoacherListClass) context).ApprovedConv(position);
                }
            }
        });
        holder.view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (context instanceof ApprovalRequestVendorVoacherListClass) {
                    ((ApprovalRequestVendorVoacherListClass) context).ViewData(position);
                }
            }
        });
    }
