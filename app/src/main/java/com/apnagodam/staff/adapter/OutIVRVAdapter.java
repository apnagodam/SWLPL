...
public class OutIVRVAdapter extends BaseRecyclerViewAdapter {
    private List<IVRListPojo.Datum> Leads;
    private Context context;
    private BaseActivity activity;
    public OutIVRVAdapter(List<IVRListPojo.Datum> leads, OutIVRListingActivity outFirstkanthaParchiListingActivity, BaseActivity activity) {
        this.Leads = leads;
    ...
    class DefaultersTopHolder extends BaseViewHolder<PricingDataBinding> {
        ...
        public void onBind(int position) {
           ...
           /* if (position==0){
            ...
            if (Leads.get(position).getG_p_case_id() != null) {
                binding.updateBagWeight.setVisibility(View.GONE);
            } else if (Leads.get(position).getiTCaseId() != null) {
                binding.updateBagWeight.setVisibility(View.VISIBLE);
            } else {
                binding.updateBagWeight.setVisibility(View.GONE);
            }
            if (Leads.get(position).getiTCaseId()!=null){
                binding.tvAction.setVisibility(View.GONE);
                binding.tvActionDone.setVisibility(View.GONE);
                ...
                binding.tvAction.setVisibility(View.GONE);
                binding.tvPhone.setText("Update IVR");
            ...
            binding.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof OutIVRListingActivity) {
                        ((OutIVRListingActivity) context).   ViewData(position);
                    }
                }
            });
            binding.updateBagWeight.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    if (context instanceof OutIVRListingActivity) {
                        ((OutIVRListingActivity) context).editBagWeightPopup(position);
                    }
                }
            });
            binding.tvPhone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof OutIVRListingActivity) {
                        ((OutIVRListingActivity) context).checkVeehicleNo(position);
                    }
                }
            });
        }
