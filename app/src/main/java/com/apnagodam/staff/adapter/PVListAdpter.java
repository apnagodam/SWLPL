...
public class PVListAdpter extends RecyclerView.Adapter<PVListAdpter.CommudityResponseViewHolder> {
    private List<PVGetListPojo.Datum> commudityResponseList;
    private Context context;
    private BaseActivity activity;

    public PVListAdpter(List<PVGetListPojo.Datum> body, PVListingActivityClass myCommudityListActivity, BaseActivity activity) {
    ...
    public void onBindViewHolder(CommudityResponseViewHolder holder, final int position) {
        ...
        holder.view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (context instanceof PVListingActivityClass) {
                    ((PVListingActivityClass) context).ViewData(position);
                }
            }
        });
    }
