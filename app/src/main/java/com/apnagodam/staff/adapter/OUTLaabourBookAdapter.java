...
public class OUTLaabourBookAdapter extends BaseRecyclerViewAdapter {
    private List<AllLabourBookListResponse.Datum> Leads;
    private Context context;
    private BaseActivity activity;
    public OUTLaabourBookAdapter(List<AllLabourBookListResponse.Datum> leads, OUTLabourBookListingActivity labourBookListingActivity, BaseActivity activity) {
        this.Leads = leads;
           ...
           /* if (position==0){
            ...
            binding.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof OUTLabourBookListingActivity) {
                        ((OUTLabourBookListingActivity) context).ViewData(position);
                    }
                }
            });
            binding.tvPhone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof OUTLabourBookListingActivity) {
                        ((OUTLabourBookListingActivity) context).checkVeehicleNo(position);
                    }
                }
            });
        }
