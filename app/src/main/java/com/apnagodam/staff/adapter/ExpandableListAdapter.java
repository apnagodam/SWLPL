...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ImageView subImageItem = convertView.findViewById(R.id.subImageItem);

        txtListChild.setText(childText);
        subImageItem.setImageResource(getChild(groupPosition, childPosition).imageLocal);
        return convertView;
    }
   ...
   //     lblListHeader.setTypeface(null, Typeface.BOLD);
    ...
    //    Typeface.createFromAsset(ApnaGodamApp.getApp().getAssets(), "fonts/RobotoLight.ttf")
        ...
        ImageView subImageItem = convertView.findViewById(R.id.subImageItem);
        subImageItem.setImageResource(getGroup(groupPosition).imageLocal);
