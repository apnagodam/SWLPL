                                    ...
                                    if (Leads.get(position).getSecondKantaParchi() == null || Leads.get(position).getSecondKantaDharamkanta() == null) {
                                        ...
                                        if (Leads.get(position).getSecondQualityReport() == null || Leads.get(position).getSendToLab() == null) {
                                            ...
                                            binding.tvLab.setOnClickListener(view -> {
                                                ...
                                                ImageView ivLabImage = dialog.findViewById(R.id.ivLabImage);
                                                ...
                                                btYes.setBackgroundColor(context.getResources().getColor(R.color.grey));
                                                ...
                                                ((StaffDashBoardActivity) context).getLabFile().observe(((StaffDashBoardActivity) context).getActivity(), new androidx.lifecycle.Observer<File>() {
                                                    @Override
                                                    public void onChanged(File file) {
                                                        ...
                                                        if (file != null && !file.getPath().isEmpty()) {
                                                            ...
                                                            var labReportBase64 = Utility.transferImageToBase64(file);
                                                                    ...
                                                                    apiService.uploadLabreport(new UploadSecoundQualityPostData(
                                                                            ...
                                                                            .subscribe(new Observer<LoginResponse>() {
                                                                                ...
                                                                                public void onNext(LoginResponse loginResponse) {
                                                                                    if (context instanceof StaffDashBoardActivity) {
                                                                                        ((StaffDashBoardActivity) context).setObservers();
                                                                                        ((StaffDashBoardActivity) context).getAllCases("");
                                                                                    }
                                                                                    ((StaffDashBoardActivity) context).hideDialog();
                                                                                    dialog.dismiss();
