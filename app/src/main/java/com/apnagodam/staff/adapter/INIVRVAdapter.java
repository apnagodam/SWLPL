...
public class INIVRVAdapter extends BaseRecyclerViewAdapter {
    private List<IVRListPojo.Datum> Leads;
    private Context context;
    private BaseActivity activity;

    public INIVRVAdapter(List<IVRListPojo.Datum> leads, INIVRListingActivity outFirstkanthaParchiListingActivity, BaseActivity activity) {
        this.Leads = leads;
           ...
           /* if (position==0){
            ...
            binding.view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof INIVRListingActivity) {
                        ((INIVRListingActivity) context).ViewData(position);
                    }
                }
            });
            binding.updateBagWeight.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof INIVRListingActivity) {
                        ((INIVRListingActivity) context).editBagWeightPopup(position);
                    }
                }
            });
            binding.tvPhone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof INIVRListingActivity) {
                        ((INIVRListingActivity) context).checkVeehicleNo(position);
                    }
                }
            });
        }
