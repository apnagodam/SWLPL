...
public class OutGatepassAdapter extends BaseRecyclerViewAdapter {
    private List<GatePassListResponse.Datum> Leads;
    private Context context;
    private BaseActivity activity;
    public OutGatepassAdapter(List<GatePassListResponse.Datum> leads, OutGatePassListingActivity outGatePassListingActivity, BaseActivity activity) {
        this.Leads = leads;
        this.context = outGatePassListingActivity;
    ...
    class DefaultersTopHolder extends BaseViewHolder<GatePassItmsUploadBinding> {
        ...
        public void onBind(int position) {
            ...
            binding.txtMybids.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof OutGatePassListingActivity) {
                        ((OutGatePassListingActivity) context).updateGatepassData(position);
                    }
                }
            });
            ...
            binding.tvPhone.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (context instanceof OutGatePassListingActivity) {
                        ((OutGatePassListingActivity) context).checkVeehicleNo(position);
                    }
                }
            });
        }
