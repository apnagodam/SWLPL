...
public class ConvancyListAdpter extends RecyclerView.Adapter<ConvancyListAdpter.CommudityResponseViewHolder> {
    ...
    public void onBindViewHolder(CommudityResponseViewHolder holder, final int position) {
        ...
        holder.tv_action.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (context instanceof MyConveyanceListClass) {
                    ((MyConveyanceListClass) context).cancelConv(position);
                }
            }
        });
        holder.view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (context instanceof MyConveyanceListClass) {
                    ((MyConveyanceListClass) context).ViewData(position);
                }
            }
        });
    }
